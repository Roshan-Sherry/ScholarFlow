...
import { BookOpen, FileText, Plus, Clock, ArrowRight, Upload, Microscope, Sparkles, X, Check, FileImage } from 'lucide-react';
                    ...
                    >
                        ...
                        >
                            <div className={`w-10 h-10 rounded-lg flex items-center justify-center ${
                                project.type === ProjectType.LIT_REVIEW ? 'bg-indigo-100 text-indigo-600' : 
